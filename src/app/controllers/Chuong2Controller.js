const Chuong2 = require('../models/Chuong2');
const {
    mutipleMongooseToObject,
    mongooseToObject,
} = require('../../util/mongoose');

class Chuong2Controller {
    // [GET] /chuong2
    chuong2(req, res, next) {
        // find all documents
        Chuong2.find({})
            .then((chuong2) => {
                res.render('chuong2', {
                    chuong2: mutipleMongooseToObject(chuong2),
                });
            })
            .catch((err) => {
                console.error('Error querying chuong2:', err);
                next(err);
            });
    }
...
module.exports = new Chuong2Controller();
